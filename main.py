...
def read_record(record_request: RecordRequestModel = Body(...,
    ...
    This function is used to obtain the records from the PRTR_transfers_summary database
...
def read_record_with_condition(record_request: RecordRequestInequalityModel = Body(...,
    ...
    '''
    Conditional records query

    This function is used to obtain the records from the PRTR_transfers_summary database based on conditions
    ...
    - Request body parameters:
        ...
        - generic_sector_code: integer
        - generic_transfer_class_id: string
        - total_transfer_amount_kg: string
        - average_transfer_amount_kg: string
        - median_transfer_amount_kg: string
        - std_transfer_amount_kg: string
        - max_transfer_amount_kg: string
        - min_transfer_amount_kg: string
    - Query parameters: 
        - skip: integer
        - limit: integer
